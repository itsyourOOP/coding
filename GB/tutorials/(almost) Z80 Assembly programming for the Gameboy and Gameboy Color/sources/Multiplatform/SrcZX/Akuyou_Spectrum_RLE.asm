...
RLE_DrawGetNextLine:
		...
		push af
			call RLE_NextScreenLineHL   ;<-- SM ***
RLE_NextScreenLineHLC_Plus2:
		pop af
		add hl,de
		dec a
...
RLE_MoreBytesPart2:
	...
	dec ix
		...
		dec hl
		dec b
		call z,RLE_NextScreenLineHL	 ;<-- SM ***
RLE_NextScreenLineHL_Plus2:
...
RLE_PlainBitmapDataNoExtras:
		...
		dec iyl
		call z,RLE_NextScreenLine  ;<-- SM ***
RLE_NextScreenLine_Plus2:
		dec bc
		ld a,b
		or c
...
RLE_OneByteData_More:
		ld a,00 		;<-- SM ***
RLE_ThisOneByte_Plus1:
		ld (de),a
		dec de
		dec iyl
		call z,RLE_NextScreenLine  ;<-- SM ***
RLE_NextScreenLineB_Plus2:
