...
SetGBPalette:
	ld (&FF47),a	;FF47 	BGP	BG & Window Palette Data  (R/W)	= $FC ;
	ld (&FF48),a	;FF48  	OBP0	Object Palette 0 Data (R/W)	= $FF ;
	cpl				;Set sprite Palette 2 to the opposite
	ld (&FF49),a	;FF49  	OBP1	Object Palette 1 Data (R/W)	= $FF ;
	ret
...
Copy2Bit:				;Write a BW bitmap font to the pattern definitons
		inc	b
		inc	c
		jr	.skip
.loop	ldi	a,(hl)		;Read in a byte and INC HL
		ld	(de),a		;Fill Bitplane 1
		inc	de
        ld  (de),a		;Fill Bitplane 2
        inc de
.skip	dec	c
		jr	nz,.loop
		dec	b
