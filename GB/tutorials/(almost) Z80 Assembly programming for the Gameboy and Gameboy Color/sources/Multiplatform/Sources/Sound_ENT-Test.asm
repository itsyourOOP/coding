...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	;	  LLLLLLLL
	ld a,%10000100
	out (&a0),a		;&A0 - Channel 0 Tone 
	;     RPCCHHHH
	ld a,%00000000
	out (&a1),a		;&A1 - Channel 0 Tone H	
	;R=Ring modulator / high Pass /  polynomial Counter distortion
	;     --VVVVVV 
	ld a,%00011111		
	;out (&A8),a		;&A8 - Tone Channel 0 L Amplitude
	;out (&AC),a		;&AC - Tone Channel 0 R Amplitude


	

	ld a,%00000100
	out (&a2),a		;&A0 - Channel 1 Tone L	LLLLLLLL 	LLLL Tone
	ld a,%00000110
	out (&a3),a		;&A1 - Channel 1 Tone H	RPCCHHHH	R=Ring modulator / high Pass /  polynomial Counter distortion / HHHH Tone
	

	ld a,%01000100
	out (&a4),a		;&A0 - Channel 2 Tone L	LLLLLLLL 	LLLL Tone
	ld a,%00000000
	out (&a5),a		;&A1 - Channel 2 Tone H	RPCCHHHH	R=Ring modulator / high Pass /  polynomial Counter distortion / HHHH Tone
;
	...
	;     RHLBCCNN
	ld a,%00000001
	out (&a6),a 		;&A6 - Noise Channel frequency	
	;Ring pass / High pass / Low Pass / Bits (1=17) /
	;polynomial Counter / Noise clock
	
	;     --VVVVVV
	ld a,%00111111
	out (&AB),a		;&AB - Noise Channel LH Amplitude  
	out (&AF),a		;&AF - Noise Channel RH Amplitude


		; -IIDDSSS
;	ld a,%00000011
;	out (&a7),a 	;&A7 - Sync & Interrupt rate

; 	Interrupts (0=1khz,1=50hz,2=tone0,3=tone1) 
;    D=da ladder (speccy 48k emu) / Sync for tone 0,1,2
	
;&A0 - Channel 0 Tone L	LLLLLLLL 	LLLL Tone
;&A1 - Channel 0 Tone H	RPCCHHHH	R=Ring modulator / high Pass /  polynomial Counter distortion / HHHH Tone
;&A2 - Channel 1 Tone L
;&A3 - Channel 1 Tone H
;&A4 - Channel 2 Tone L
;&A5 - Channel 2 Tone H
