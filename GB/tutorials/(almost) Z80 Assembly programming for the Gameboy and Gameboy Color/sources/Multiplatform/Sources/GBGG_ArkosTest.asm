...
AYCache equ Gameram+64 

;Arkos_VarsDefined equ 1

;PLY_PSGRegistersArray equ TileMap

;PLY_PSGReg6 equ PLY_PSGRegistersArray+6		;6
;PLY_PSGReg11 equ PLY_PSGRegistersArray+12		;12
;PLY_PSGReg13 equ PLY_PSGRegistersArray+14		;14
...
ayRegisterWrite:	;A=regsiter, C=Value
	push hl
		ld hl,AYCache
		add l
		ld l,a
...
GBChannelb_L equ 4;2
GBChannelb_H equ 5;3	
GBChannelb_V equ 10;9
GBChannelb_M equ 2;1

GBChannelw_L equ 2;4
GBChannelw_H equ 3;5
GBChannelw_V equ 9;10
GBChannelw_M equ 1;2
	...
	ld (&FF1A),a
		...
		ld a,(AYCache+GBChannelw_H)	;3
		cpl
		ld h,a
		ld a,(AYCache+GBChannelw_L)	;2
		cpl
		ld l,a
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
		...
		ld a,(AYCache+GBChannela_H)
		cpl
		ld h,a
		
		ld a,(AYCache+GBChannela_L)
		cpl
		ld l,a
		or a
		;rl l
		...
		ld a,(AYCache+GBChannelb_H)
		cpl
		ld h,a
		ld a,(AYCache+GBChannelb_L)
		cpl
		ld l,a
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
	...
	bit GBChannela_M,b				;Check if Channel 1 is muted
	jr nz,Envelope1Mute
	
	ld a,(AYCache+GBChannela_V)
	;call Monitor
	cp 16
	jr c,SkipEnvelope1
	xor %00001111
...
Envelope1Done:
	...
	bit GBChannelb_M,b				;Check if Channel 1 is muted
	jr nz,Envelope2Mute
	
	
	ld a,(AYCache+GBChannelb_V)
...
Envelope2Done:
	...
	bit GBChannelw_M,b	;1			;Check if Wave Channel
	jr z,Envelope3Mute
	
	ld a,(AYCache+GBChannelw_V);9
	;or a
	;jr z,Envelope3Mute
	;ld a,%00100000
	cp 16
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
	...
	bit 0,b				;Check if Channel 1 is muted
	jr nz,Envelope1Mute
...
SkipEnvelope1:
	and %00001111
	or %10010000	;1CCTVVVV	(Latch - Channel Type Volume 0=max)	
	out (&7F),a
	jr Envelope1Done	
Envelope1Mute:
	ld a,%10011111
	out (&7F),a
Envelope1Done:
	bit 1,b				;Check if Channel 2 is muted
	jr nz,Envelope2Mute
...
SkipEnvelope2:
	and %00001111
	or %10110000	;1CCTVVVV	(Latch - Channel Type Volume 0=max)	
	out (&7F),a
	jr Envelope2Done	
Envelope2Mute:
	ld a,%10111111
	out (&7F),a
Envelope2Done:
	bit 2,b				;Check if Channel 3 is muted
	jr nz,Envelope3Mute
...
SkipEnvelope3:	
	and %00001111
	or  %11010000	;1CCTVVVV	(Latch - Channel Type Volume 0=max)	
	out (&7F),a
	jr Envelope3Done	
Envelope3Mute:
	ld a,%11011111
...
Envelope3Done:
	...
	and %00111000
	jr z,NoNoise
	ld a, %11110000	;1CCTVVVV	(Latch - Channel Type Volume 0=max)	
	jr NoiseDone
...
;	or %11100000	;1CCT-MRR	(Latch - Channel Type... noise Mode (1=white) Rate (Rate 11= use Tone Channel 2)
;	out (&7F),a
	...
	ifdef BuildSMS
		ld a,%11000000	;1CCTLLLL	(Latch - Channel Type DataL
		out (&7F),a
		...
		ld a,%11010000	;1CCTVVVV	(Latch - Channel Type Volume 0=max)	
		out (&7F),a
	endif
...
Akuyou_MusicPos:
Akuyou_SfxPos:
	incbin "..\ResALL\MusicTest6000.bin"
