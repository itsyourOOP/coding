...
ScreenINIT:
	...
	ld a,%01100100	;	Bit 0 R/W  BCD 1 of video page control.
	...
	ld a,%00011111	;	Bit 0 R/W  BCD 1 of low memory page control.
...
ScreenLinePos_Plus2:
		...
		add e
		ld e,a
		jr nc,GetNextLineDone2
		inc d
GetNextLineDone2:
	ld (ScreenLinePos_Plus2-2),de
	ret
