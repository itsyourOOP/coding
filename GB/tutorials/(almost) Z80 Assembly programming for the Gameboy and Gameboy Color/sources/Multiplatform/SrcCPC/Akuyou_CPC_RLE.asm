...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	ld a,b
	and %00110000						;Top 4 bits are the RLE data
...
RLE_MoreBytes:
		ld a,c
		and %00110011					;Write this nibble - note the pattern matches 
...
RLE_MoreBytesPart2:
		ld a,c
		and %11001100					;Write the second nibble - or in the last one
		or d
		ld d,a
...
ImageWidthE_Plus1						;Reset B
		ld de,&800+RLE_ImageWidth ;<--SM ***
ImageWidthD_Plus2
		add hl,de						;Add width
	pop de
	ret nc
	push de
		ld de,&c050						;Note this only works for screen at &c000 
